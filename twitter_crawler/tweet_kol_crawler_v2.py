...
if __name__ == "__main__":
    ...
    parser.add_argument("--pages", type=int, help="Number of scroll down refreshing times during the crawling")
    parser.add_argument("--wait_time", type=int, help="Interval to wait between 2 pages in seconds")
